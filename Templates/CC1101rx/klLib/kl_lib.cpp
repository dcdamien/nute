...
void klPinIrq_t::IrqSetup(EXTITrigger_TypeDef ATriggerType) {
    ...
    // Get IRQ channel
    if      (IPinNumber == 0) IChannel = EXTI0_IRQn;
    else if (IPinNumber == 1) IChannel = EXTI1_IRQn;
    else if (IPinNumber == 2) IChannel = EXTI2_IRQn;
    else if (IPinNumber == 3) IChannel = EXTI3_IRQn;
    else if (IPinNumber == 4) IChannel = EXTI4_IRQn;
