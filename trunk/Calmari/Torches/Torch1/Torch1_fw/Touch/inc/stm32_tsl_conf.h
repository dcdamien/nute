...
#define CLWHTA                             (0)  /**< Waiting time during capacitor charging: value from 0 to 50 (= 1.56µs @ 32MHz) */
// Capacitance Loading Waiting LOW Time Adjustment
#define CLWLTA                             (0)  /**< Waiting time during transfer phase: value from 0 to 50 (= 1.56µs @ 32MHz) */
