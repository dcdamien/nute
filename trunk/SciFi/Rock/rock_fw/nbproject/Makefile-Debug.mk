...
${OBJECTDIR}/leds_pca.o: leds_pca.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -DSTM32F10X_HD -I. -Ilib -Ilib/inc -MMD -MP -MF $@.d -o ${OBJECTDIR}/leds_pca.o leds_pca.cpp

${OBJECTDIR}/main.o: main.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -DSTM32F10X_HD -I. -Ilib -Ilib/inc -MMD -MP -MF $@.d -o ${OBJECTDIR}/main.o main.cpp
...
${OBJECTDIR}/i2c_mgr.o: i2c_mgr.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -DSTM32F10X_HD -I. -Ilib -Ilib/inc -MMD -MP -MF $@.d -o ${OBJECTDIR}/i2c_mgr.o i2c_mgr.cpp
...
${OBJECTDIR}/delay_util.o: delay_util.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -DSTM32F10X_HD -I. -Ilib -Ilib/inc -MMD -MP -MF $@.d -o ${OBJECTDIR}/delay_util.o delay_util.cpp

${OBJECTDIR}/uart.o: uart.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -DSTM32F10X_HD -I. -Ilib -Ilib/inc -MMD -MP -MF $@.d -o ${OBJECTDIR}/uart.o uart.cpp
