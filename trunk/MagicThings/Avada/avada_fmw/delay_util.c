...
#elif F_CPU == 8000000
    #define DELAY_TCCR  (0<<CS02)|(1<<CS01)|(1<<CS00)   // 8 MHz/64 = 125 kHz;
    #define DELAY_OCRA  125
#else
...
#elif defined __AVR_ATmega16U2__ || __AVR_ATmega32U2__
    TCCR0A = (1<<WGM01);    // CTC mode
    TCCR0B = DELAY_TCCR;
    OCR0A  = DELAY_OCRA;
    TIMSK0 |= (1<<OCIE0A);  // Enable interrupt
...
// ================================ Interrupts =================================
// Delay counter
#if defined __AVR_ATmega88__ ||  __AVR_ATmega16U2__ || __AVR_ATmega32U2__
