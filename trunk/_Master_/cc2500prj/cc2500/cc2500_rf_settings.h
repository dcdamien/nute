...
//#define CC_PATABLE0_VALUE   0x6E    // -8  dBm
...
#define CC_FREQ1_VALUE      0xED        // Frequency control word, middle byte.
#define CC_FREQ0_VALUE      0x08        // Frequency control word, low byte.

// =================================== Common ==================================
#define CC_MDMCFG1_VALUE    0b10100011  // FEC=1, Preamble length=010 => 4bytes, +Channel spacing
...
#define CC_FSCTRL1_VALUE    0x06        // Frequency synthesizer control: IF = 158 kHz @ 27MHz crystal
...
#define CC_MDMCFG0_VALUE    0x2F        // Modem configuration: frequencies
