...
namespace HonorSerialportGateConsole.ServerWCFService {
    ...
    public partial class PlayerUpdate : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private byte NewPulseField;
        
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private byte NewRoomField;
        
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private byte NewTempField;
        
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private byte NewToxinField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public byte NewPulse {
            get {
                return this.NewPulseField;
            }
            set {
                if ((this.NewPulseField.Equals(value) != true)) {
                    this.NewPulseField = value;
                    this.RaisePropertyChanged("NewPulse");
                }
            }
        }
        ...
        public byte NewTemp {
            get {
                return this.NewTempField;
            }
            set {
                if ((this.NewTempField.Equals(value) != true)) {
                    this.NewTempField = value;
                    this.RaisePropertyChanged("NewTemp");
                }
            }
        }
        
        [System.Runtime.Serialization.DataMemberAttribute()]
        public byte NewToxin {
            get {
                return this.NewToxinField;
            }
            set {
                if ((this.NewToxinField.Equals(value) != true)) {
                    this.NewToxinField = value;
                    this.RaisePropertyChanged("NewToxin");
                }
            }
        }
    ...
    public interface IGateWCFService {
        ...
        System.IAsyncResult BeginTXCompleted(byte[] payload, System.AsyncCallback callback, object asyncState);
    ...
    public interface IGateWCFServiceCallback {
        ...
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="http://tempuri.org/IGateWCFService/SendHeartbeat")]
        void SendHeartbeat();
        
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, AsyncPattern=true, Action="http://tempuri.org/IGateWCFService/SendHeartbeat")]
    ...
    public partial class GateWCFServiceClient : System.ServiceModel.DuplexClientBase<HonorSerialportGateConsole.ServerWCFService.IGateWCFService>, HonorSerialportGateConsole.ServerWCFService.IGateWCFService {
        ...
        public void TXCompleted(byte[] payload) {
            base.Channel.TXCompleted(payload);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        public System.IAsyncResult BeginTXCompleted(byte[] payload, System.AsyncCallback callback, object asyncState) {
            return base.Channel.BeginTXCompleted(payload, callback, asyncState);
        }
        ...
        private System.IAsyncResult OnBeginTXCompleted(object[] inValues, System.AsyncCallback callback, object asyncState) {
            byte[] payload = ((byte[])(inValues[0]));
            return this.BeginTXCompleted(payload, callback, asyncState);
        }
        ...
        public void TXCompletedAsync(byte[] payload) {
            this.TXCompletedAsync(payload, null);
        }
        
        public void TXCompletedAsync(byte[] payload, object userState) {
            ...
            base.InvokeAsync(this.onBeginTXCompletedDelegate, new object[] {
                        payload}, this.onEndTXCompletedDelegate, this.onTXCompletedCompletedDelegate, userState);
        }
