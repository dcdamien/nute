...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=http%3A%2F%2Fcode.google.com%2Fp%2Fmagicstuff-rpg%2Fsource%2Fbrowse%2Ftrunk%2Frfm22%2Frf%2Frfm_hw.h" 
...
<div id="nav_and_rev" class="heading">
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/magicstuff-rpg/source/browse/trunk/">trunk</a><span class="sp">/&nbsp;</span><a href="/p/magicstuff-rpg/source/browse/trunk/rfm22/">rfm22</a><span class="sp">/&nbsp;</span><a href="/p/magicstuff-rpg/source/browse/trunk/rfm22/rf/">rf</a><span class="sp">/&nbsp;</span>rfm_hw.h</span>
...
><td class="source"> * rfm_hw.h<br></td></tr
><tr
id=sl_svn42_3
...
><td class="source">#ifndef RFM_HW_H_<br></td></tr
><tr
id=sl_svn42_9

><td class="source">#define RFM_HW_H_<br></td></tr
><tr
id=sl_svn42_10
...
><td class="source">/* Аппаратно-зависимые настройки прерывания */<br></td></tr
><tr
id=sl_svn42_14

><td class="source">#define RFM_NIRQ_PORT	GPIOA<br></td></tr
><tr
id=sl_svn42_15

><td class="source">#define RFM_NIRQ_PIN	GPIO_Pin_0<br></td></tr
><tr
id=sl_svn42_16

><td class="source">#define RFM_IRQ			EXTI0_IRQHandler(void)<br></td></tr
><tr
id=sl_svn42_17
...
><td class="source">#define NBUFSIZE 10<br></td></tr
><tr
id=sl_svn42_19

><td class="source">#define VALID_DEVTYPE 0x08<br></td></tr
><tr
id=sl_svn42_20
...
><td class="source">typedef enum _RF_STATUS {<br></td></tr
><tr
id=sl_svn42_22

><td class="source">rf_start		=0x00,<br></td></tr
><tr
id=sl_svn42_23

><td class="source">rf_por			=0x01,<br></td></tr
><tr
id=sl_svn42_24

><td class="source">rf_idle			=0x02,<br></td></tr
><tr
id=sl_svn42_25

><td class="source">rf_rx			=0x03,<br></td></tr
><tr
id=sl_svn42_26

><td class="source">rf_rxc			=0x04,<br></td></tr
><tr
id=sl_svn42_27

><td class="source">rf_rxerr		=0x05,<br></td></tr
><tr
id=sl_svn42_28

><td class="source">rf_tx			=0x06,<br></td></tr
><tr
id=sl_svn42_29

><td class="source">rf_txc			=0x07,<br></td></tr
><tr
id=sl_svn42_30

><td class="source">rf_txerr		=0x08,<br></td></tr
><tr
id=sl_svn42_31

><td class="source">}RF_STATUS;<br></td></tr
><tr
id=sl_svn42_32
...
><td class="source">volatile RF_STATUS rf_status = rf_start;<br></td></tr
><tr
id=sl_svn42_34
...
><td class="source">#endif /* RFM_HW_H_ */<br></td></tr
></table></pre>
<pre class="prettyprint"><table width="100%"><tr class="cursor_stop cursor_hidden"><td></td></tr></table></pre>
</td>
</tr></table>
<script type="text/javascript">
 ...
 by chai.mail0
 on Dec 05, 2010
 &nbsp; <a href="/p/magicstuff-rpg/source/diff?spec=svn42&r=39&amp;format=side&amp;path=/trunk/rfm22/rf/rfm_hw.h&amp;old_path=/trunk/rfm22/rf/rfm_hw.h&amp;old=">Diff</a>
 </div>
 ...
 var selected_path = '/trunk/rfm22/rf/rfm_hw.h';
 ...
 <a href="/p/magicstuff-rpg/source/list?path=/trunk/rfm22/rf/rfm_hw.h&start=39">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div><a href="http://magicstuff-rpg.googlecode.com/svn/trunk/rfm22/rf/rfm_hw.h">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn42': '/trunk/rfm22/rf/rfm_hw.h'}
