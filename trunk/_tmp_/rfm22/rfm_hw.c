...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=http%3A%2F%2Fcode.google.com%2Fp%2Fmagicstuff-rpg%2Fsource%2Fbrowse%2Ftrunk%2Frfm22%2Frf%2Frfm_hw.c" 
...
<div id="nav_and_rev" class="heading">
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/magicstuff-rpg/source/browse/trunk/">trunk</a><span class="sp">/&nbsp;</span><a href="/p/magicstuff-rpg/source/browse/trunk/rfm22/">rfm22</a><span class="sp">/&nbsp;</span><a href="/p/magicstuff-rpg/source/browse/trunk/rfm22/rf/">rf</a><span class="sp">/&nbsp;</span>rfm_hw.c</span>
...
><td class="source"> * rfm_hw.c<br></td></tr
><tr
id=sl_svn42_3
...
><td class="source">#include &quot;stm32f10x.h&quot;<br></td></tr
><tr
id=sl_svn42_9
...
><td class="source">#include &quot;rfm_hw.h&quot;<br></td></tr
><tr
id=sl_svn42_11

><td class="source">#include &quot;rfm_hwconfig.h&quot;<br></td></tr
><tr
id=sl_svn42_12
...
><td class="source">void RFM_IRQ {<br></td></tr
><tr
id=sl_svn42_15
...
><td class="source">	uint16_t inistatus;<br></td></tr
><tr
id=sl_svn42_17
...
><td class="source">	rf_spi_read(InterruptStatus1, (uint8_t *)&amp;inistatus, 2);<br></td></tr
><tr
id=sl_svn42_19

><td class="source">	switch (rf_status) {<br></td></tr
><tr
id=sl_svn42_20

><td class="source">		case rf_idle:<br></td></tr
><tr
id=sl_svn42_21
...
><td class="source">		case rf_tx:<br></td></tr
><tr
id=sl_svn42_24
...
><td class="source">		case rf_rx:<br></td></tr
><tr
id=sl_svn42_27
...
><td class="source">		case rf_txc:<br></td></tr
><tr
id=sl_svn42_30
...
><td class="source">		case rf_rxc:<br></td></tr
><tr
id=sl_svn42_33
...
><td class="source">		case rf_txerr:<br></td></tr
><tr
id=sl_svn42_36

><td class="source">		case rf_rxerr:<br></td></tr
><tr
id=sl_svn42_37
...
><td class="source">		case rf_start:<br></td></tr
><tr
id=sl_svn42_40

><td class="source">			rf_status = rf_por;<br></td></tr
><tr
id=sl_svn42_41

><td class="source">		default:  // Если случилось что-то неожиданное и непоправимое<br></td></tr
><tr
id=sl_svn42_42

><td class="source">			reti();<br></td></tr
><tr
id=sl_svn42_43
...
><td class="source">uint8_t rfm_init (void) {<br></td></tr
><tr
id=sl_svn42_47
...
><td class="source">	uint8_t buf[NBUFSIZE];<br></td></tr
><tr
id=sl_svn42_49
...
><td class="source">	rf_spi_read(DeviceType, buf, 5); // Читаем deviceID, статус-регистр и сбрасываем статусы прерываний<br></td></tr
><tr
id=sl_svn42_51

><td class="source">	if (buf[0] != VALID_DEVTYPE) return (255); // Если железка не та, завершаем работу с ней<br></td></tr
><tr
id=sl_svn42_52

><td class="source">/* Устраиваем софтварный ресет для установки регистров в POR */<br></td></tr
><tr
id=sl_svn42_53

><td class="source">	SW_RESET;<br></td></tr
><tr
id=sl_svn42_54

><td class="source">	while(GPIO_ReadOutputDataBit(RFM_NIRQ_PORT, RFM_NIRQ_PIN));<br></td></tr
><tr
id=sl_svn42_55

><td class="source">	rf_spi_read(InterruptStatus1, buf, 2);<br></td></tr
><tr
id=sl_svn42_56

><td class="source">/* Установка конфигурации трансивера. См. конфигурационный файл rfm_hwconfig.h */<br></td></tr
><tr
id=sl_svn42_57

><td class="source">	SET_FREQ;<br></td></tr
><tr
id=sl_svn42_58

><td class="source">	SET_MODEM;<br></td></tr
><tr
id=sl_svn42_59

><td class="source">	SET_TXDATARATE;<br></td></tr
><tr
id=sl_svn42_60

><td class="source">	SET_PACKETHANDLER;<br></td></tr
><tr
id=sl_svn42_61

><td class="source">	SET_RFSWITCH;<br></td></tr
><tr
id=sl_svn42_62

><td class="source">/* Установка прерываний */<br></td></tr
><tr
id=sl_svn42_63

><td class="source">	SET(InterruptEnable1, 1&lt;&lt;IFFERR | 1&lt;&lt;ITXFFAFULL | 1&lt;&lt;ITXFFAEM | 1&lt;&lt;IRXFFAFULL | 1&lt;&lt;IPKSENT | 1&lt;&lt;IPKVALID);<br></td></tr
><tr
id=sl_svn42_64

><td class="source">	SET(InterruptEnable2, 1&lt;&lt;ENCHIPRDY | 1&lt;&lt;ENPOR);<br></td></tr
><tr
id=sl_svn42_65

><td class="source">/* Уходим в простой */<br></td></tr
><tr
id=sl_svn42_66

><td class="source">	SET(OperatingFunctionControl1, 1&lt;&lt;XTON);<br></td></tr
><tr
id=sl_svn42_67

><td class="source">	rf_status = rf_idle;<br></td></tr
><tr
id=sl_svn42_68
...
><td class="source">void rfm_switchrx(void) {<br></td></tr
><tr
id=sl_svn42_72
...
><td class="source">void rfm_switchtx(void) {<br></td></tr
><tr
id=sl_svn42_76
...
><td class="source">void rfm_switchidle(void) {<br></td></tr
><tr
id=sl_svn42_80
...
><td class="source">void rfm_readfifo (uint8_t *buf, uint8_t count){<br></td></tr
><tr
id=sl_svn42_84
...
<script type="text/javascript">
 ...
 by chai.mail0
 on Dec 05, 2010
 &nbsp; <a href="/p/magicstuff-rpg/source/diff?spec=svn42&r=39&amp;format=side&amp;path=/trunk/rfm22/rf/rfm_hw.c&amp;old_path=/trunk/rfm22/rf/rfm_hw.c&amp;old=">Diff</a>
 </div>
 ...
 var selected_path = '/trunk/rfm22/rf/rfm_hw.c';
 ...
 <a href="/p/magicstuff-rpg/source/list?path=/trunk/rfm22/rf/rfm_hw.c&start=39">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div><a href="http://magicstuff-rpg.googlecode.com/svn/trunk/rfm22/rf/rfm_hw.c">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn42': '/trunk/rfm22/rf/rfm_hw.c'}
