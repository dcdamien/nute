...
ThreeKShell::TextBoxFactory::TextBoxFactory(Repositories* styles, IRender* renderer)
{
	_styles = styles;
	_renderer = renderer;
	ResetDefaults();
...
fresult ThreeKShell::TextBoxFactory::ResetDefaults()
{
	fresult fres;
...
fresult ThreeKShell::TextBoxFactory::GetTextBox(Position pos, const char* text , TextField** o_tf)
{
	//autosize it
...
fresult ThreeKShell::TextBoxFactory::GetTextBox(Position pos, Size sizepx , TextField** o_tf)
{
	fresult fres;
...
fresult ThreeKShell::TextBoxFactory::GetTextBox(Position pos, const char* text, Size sizepx, bool_t staticText, TextField** o_tf)
{
	fresult fres;
...
fresult ThreeKShell::TextBoxFactory::GetTextBox(Position pos, const char* text, Size sizepx, char* buff, Size buffSz , TextField** o_tf)
{
	fresult fres;
...
char* ThreeKShell::TextBoxFactory::AllocBuffBySizePx( Size sizePx, const TextFormat* tf, ubyte_t pages, Size* o_buffSz)
{
	Size szTx;	
...
char* ThreeKShell::TextBoxFactory::AllocBuffBySizeTx( Size sizeTx, ubyte_t pages, Size* o_buffSz)
{
	Size buffSz;
...
char* ThreeKShell::TextBoxFactory::allocBytes( uword_t io_len )
{
	return new char[io_len];
}

TextField* ThreeKShell::TextBoxFactory::allocTextField()
{
