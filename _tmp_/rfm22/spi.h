...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=http%3A%2F%2Fcode.google.com%2Fp%2Fmagicstuff-rpg%2Fsource%2Fbrowse%2Ftrunk%2Frfm22%2Frf%2Fspi.h" 
...
<div id="nav_and_rev" class="heading">
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/magicstuff-rpg/source/browse/trunk/">trunk</a><span class="sp">/&nbsp;</span><a href="/p/magicstuff-rpg/source/browse/trunk/rfm22/">rfm22</a><span class="sp">/&nbsp;</span><a href="/p/magicstuff-rpg/source/browse/trunk/rfm22/rf/">rf</a><span class="sp">/&nbsp;</span>spi.h</span>
...
><td class="source"> * spi.h<br></td></tr
><tr
id=sl_svn42_3
...
><td class="source">#ifndef SPI_H_<br></td></tr
><tr
id=sl_svn42_9

><td class="source">#define SPI_H_<br></td></tr
><tr
id=sl_svn42_10
...
><td class="source">//SPI port<br></td></tr
><tr
id=sl_svn42_12

><td class="source">#define DDR_SPI DDRB<br></td></tr
><tr
id=sl_svn42_13

><td class="source">#define PORT_SPI PORTB<br></td></tr
><tr
id=sl_svn42_14

><td class="source">#define PIN_SPI PINB<br></td></tr
><tr
id=sl_svn42_15

><td class="source">#define BIT_MOSI 3<br></td></tr
><tr
id=sl_svn42_16

><td class="source">#define BIT_MISO 4<br></td></tr
><tr
id=sl_svn42_17

><td class="source">#define BIT_SCK  5<br></td></tr
><tr
id=sl_svn42_18

><td class="source">#define BIT_SS 2<br></td></tr
><tr
id=sl_svn42_19

><td class="source">//this is the hardware SS pin of the AVR - it<br></td></tr
><tr
id=sl_svn42_20

><td class="source">//needs to be set to output for the spi-interface to work<br></td></tr
><tr
id=sl_svn42_21

><td class="source">//correctly, independently of the CS pin used<br></td></tr
><tr
id=sl_svn42_22
...
><td class="source">#define SS_ASSERT	PORT_SPI &amp;= ~(1&lt;&lt;BIT_SS)<br></td></tr
><tr
id=sl_svn42_24

><td class="source">#define SS_RELEASE	PORT_SPI |= (1&lt;&lt;BIT_SS)<br></td></tr
><tr
id=sl_svn42_25
...
><td class="source">#endif /* SPI_H_ */<br></td></tr
></table></pre>
<pre class="prettyprint"><table width="100%"><tr class="cursor_stop cursor_hidden"><td></td></tr></table></pre>
</td>
</tr></table>
<script type="text/javascript">
 ...
 by chai.mail0
 on Dec 05, 2010
 &nbsp; <a href="/p/magicstuff-rpg/source/diff?spec=svn42&r=39&amp;format=side&amp;path=/trunk/rfm22/rf/spi.h&amp;old_path=/trunk/rfm22/rf/spi.h&amp;old=">Diff</a>
 </div>
 ...
 var selected_path = '/trunk/rfm22/rf/spi.h';
 ...
 <a href="/p/magicstuff-rpg/source/list?path=/trunk/rfm22/rf/spi.h&start=39">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div><a href="http://magicstuff-rpg.googlecode.com/svn/trunk/rfm22/rf/spi.h">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn42': '/trunk/rfm22/rf/spi.h'}
