...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=http%3A%2F%2Fcode.google.com%2Fp%2Fmagicstuff-rpg%2Fsource%2Fbrowse%2Ftrunk%2Frfm22%2Frf%2Frfm_hwconfig.h" 
...
<div id="nav_and_rev" class="heading">
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/magicstuff-rpg/source/browse/trunk/">trunk</a><span class="sp">/&nbsp;</span><a href="/p/magicstuff-rpg/source/browse/trunk/rfm22/">rfm22</a><span class="sp">/&nbsp;</span><a href="/p/magicstuff-rpg/source/browse/trunk/rfm22/rf/">rf</a><span class="sp">/&nbsp;</span>rfm_hwconfig.h</span>
...
><td class="source"> * rfm_hwconfig.h<br></td></tr
><tr
id=sl_svn42_3
...
><td class="source"> *  Created on: Sep 20, 2010<br></td></tr
><tr
id=sl_svn42_5
...
><td class="source">#ifndef RFM_HWCONFIG_H_<br></td></tr
><tr
id=sl_svn42_9

><td class="source">#define RFM_HWCONFIG_H_<br></td></tr
><tr
id=sl_svn42_10
...
><td class="source">#include &quot;rfm22b_registermap.h&quot;<br></td></tr
><tr
id=sl_svn42_12
...
><td class="source">#define PHY_868<br></td></tr
><tr
id=sl_svn42_16
...
><td class="source">#ifdef PHY_868<br></td></tr
><tr
id=sl_svn42_18

><td class="source">/* Low-level definitions */<br></td></tr
><tr
id=sl_svn42_19
...
><td class="source">#define SET(reg, value)			rf_spi_write_byte(reg, value)<br></td></tr
><tr
id=sl_svn42_21
...
><td class="source">#define SET_IFFilterBandwidth	SET(IFFilterBandwidth, 0x95)<br></td></tr
><tr
id=sl_svn42_23
...
><td class="source">#define SET_AFCLoopGearshiftOverride	SET(AFCLoopGearshiftOverride, 0x6B)<br></td></tr
><tr
id=sl_svn42_25
...
><td class="source">#define SET_ClockRecoveryOffset1	SET(ClockRecoveryOffset1, 0x31)<br></td></tr
><tr
id=sl_svn42_27
...
><td class="source">#define SET_ClockRecoveryOffset0	SET(ClockRecoveryOffset0, 0xD6)<br></td></tr
><tr
id=sl_svn42_29
...
><td class="source">#define SET_ClockRecoveryTimingLoopGain1 	SET(ClockRecoveryTimingLoopGain1, 0x02)<br></td></tr
><tr
id=sl_svn42_31
...
><td class="source">#define SET_ClockRecoveryTimingLoopGain0 	SET(ClockRecoveryTimingLoopGain1, 0xB0)<br></td></tr
><tr
id=sl_svn42_33
...
><td class="source">#define SET_AFCLimiter			SET(AFCLimiter, 0x3C)<br></td></tr
><tr
id=sl_svn42_35
...
><td class="source">#define SET_DataAccessControl	SET(DataAccessControl, 0xAD)<br></td></tr
><tr
id=sl_svn42_37
...
><td class="source">#define SET_HeaderControl1		SET(HeaderControl1, 0xCC)<br></td></tr
><tr
id=sl_svn42_39
...
><td class="source">#define SET_HeaderControl2		SET(HeaderControl2, 0x4A)<br></td></tr
><tr
id=sl_svn42_41
...
><td class="source">#define SET_PreambleLength		SET(PreambleLength, 0x10)<br></td></tr
><tr
id=sl_svn42_43
...
><td class="source">#define SET_TransmitPacketLength	SET(TransmitPacketLength, 0x20)<br></td></tr
><tr
id=sl_svn42_45
...
><td class="source">#define SET_TXDataRate1			SET(TXDataRate1, 0x0E)<br></td></tr
><tr
id=sl_svn42_47
...
><td class="source">#define SET_TXDataRate0			SET(TXDataRate0, 0x56)<br></td></tr
><tr
id=sl_svn42_49
...
><td class="source">#define SET_ModulationModeControl2	SET(ModulationModeControl2, 0x23)<br></td></tr
><tr
id=sl_svn42_51
...
><td class="source">#define SET_FrequencyDeviation	SET(FrequencyDeviation, 0x50)<br></td></tr
><tr
id=sl_svn42_53
...
><td class="source">#define SET_FrequencyBandSelect	SET(FrequencyBandSelect, 0x73)<br></td></tr
><tr
id=sl_svn42_55
...
><td class="source">#define SET_NominalCarrierFrequency1	SET(NominalCarrierFrequency1, 0x64)<br></td></tr
><tr
id=sl_svn42_57
...
><td class="source">#define SET_NominalCarrierFrequency0	SET(NominalCarrierFrequency0, 0x00)<br></td></tr
><tr
id=sl_svn42_59
...
><td class="source">#define SET_GPIO1Configuration	SET(GPIO1Configuration, 0x12)<br></td></tr
><tr
id=sl_svn42_61
...
><td class="source">#define SET_GPIO2Configuration	SET(GPIO2Configuration,0x15)<br></td></tr
><tr
id=sl_svn42_63
...
><td class="source">#define SW_RESET				SET(OperatingFunctionControl1, 0x80)<br></td></tr
><tr
id=sl_svn42_65
...
><td class="source">/* User-space definitions*/<br></td></tr
><tr
id=sl_svn42_67
...
><td class="source">#define SET_FREQ				SET_FrequencyBandSelect, SET_NominalCarrierFrequency1, SET_NominalCarrierFrequency0<br></td></tr
><tr
id=sl_svn42_69
...
><td class="source">#define SET_MODEM				SET_IFFilterBandwidth, SET_ClockRecoveryOffset1, SET_ClockRecoveryOffset0, \<br></td></tr
><tr
id=sl_svn42_71

><td class="source">								SET_ClockRecoveryTimingLoopGain1, SET_ClockRecoveryTimingLoopGain0, \<br></td></tr
><tr
id=sl_svn42_72

><td class="source">								SET_AFCLimiter, SET_AFCLoopGearshiftOverride, SET_FrequencyDeviation<br></td></tr
><tr
id=sl_svn42_73
...
><td class="source">#define SET_TXDATARATE			SET_TXDataRate1, SET_TXDataRate0<br></td></tr
><tr
id=sl_svn42_75

><td class="source">#define SET_PACKETHANDLER		SET_PreambleLength, SET_HeaderControl2, SET_DataAccessControl, SET_HeaderControl1, SET_ModulationModeControl2, SET_TransmitPacketLength<br></td></tr
><tr
id=sl_svn42_76

><td class="source">#define SET_RFSWITCH			SET_GPIO1Configuration, SET_GPIO2Configuration<br></td></tr
><tr
id=sl_svn42_77

><td class="source">#endif /* PHY_868 */<br></td></tr
><tr
id=sl_svn42_78
...
><td class="source">#endif /* RFM_HWCONFIG_H_ */<br></td></tr
></table></pre>
<pre class="prettyprint"><table width="100%"><tr class="cursor_stop cursor_hidden"><td></td></tr></table></pre>
</td>
</tr></table>
<script type="text/javascript">
 ...
 by chai.mail0
 on Dec 05, 2010
 &nbsp; <a href="/p/magicstuff-rpg/source/diff?spec=svn42&r=39&amp;format=side&amp;path=/trunk/rfm22/rf/rfm_hwconfig.h&amp;old_path=/trunk/rfm22/rf/rfm_hwconfig.h&amp;old=">Diff</a>
 </div>
 ...
 var selected_path = '/trunk/rfm22/rf/rfm_hwconfig.h';
 ...
 <a href="/p/magicstuff-rpg/source/list?path=/trunk/rfm22/rf/rfm_hwconfig.h&start=39">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div><a href="http://magicstuff-rpg.googlecode.com/svn/trunk/rfm22/rf/rfm_hwconfig.h">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn42': '/trunk/rfm22/rf/rfm_hwconfig.h'}
