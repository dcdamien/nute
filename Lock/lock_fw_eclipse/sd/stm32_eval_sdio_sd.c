...
static SD_Error FindSCR(uint32_t *pscr);
...
#ifdef SD_VERBOSE_INIT
    UART_StrInt("SD PowerOn: ", errorstatus);
#endif
...
#ifdef SD_VERBOSE_INIT
    UART_StrInt("SD_InitializeCards: ", errorstatus);
#endif
...
#ifdef SD_VERBOSE_INIT
        UART_StrInt("SD_GetCardInfo: ", errorstatus);
#endif
    }
...
#ifdef SD_VERBOSE_INIT
        // Print card info
        UART_PrintString("SD Info:\r");
        UART_StrInt("CardBlockSize: ", SDCardInfo.CardBlockSize);
        UART_StrInt("CardCapacity: ", SDCardInfo.CardCapacity);
        UART_StrInt("CardType: ", SDCardInfo.CardType);
        UART_StrInt("RCA: ", SDCardInfo.RCA);
#endif
        /*----------------- Select Card --------------------------------*/
        errorstatus = SD_SelectDeselect((uint32_t) (SDCardInfo.RCA << 16));
#ifdef SD_VERBOSE_INIT
        UART_StrInt("SD_SelectDeselect: ", errorstatus);
#endif
    }
...
#ifdef SD_VERBOSE_INIT
        UART_StrInt("SD_EnableWideBusOperation: ", errorstatus);
#endif
    }
...
SD_Error SD_PowerON(void) {
    ...
    UART_PrintString("SD Power on\r");
#endif
    SD_Error errorstatus = SD_OK;
    ...
    // DEBUG
#ifdef SD_VERBOSE_POWER_ON
    UART_StrInt("GO_IDLE_STATE: ", errorstatus);
#endif
    if (errorstatus != SD_OK) {
        /*!< CMD Response TimeOut (wait for CMDSENT flag) */
        return (errorstatus);
    ...
    // DEBUG
#ifdef SD_VERBOSE_POWER_ON
    UART_StrInt("SEND_IF_COND: ", errorstatus);
#endif
    ...
    if (errorstatus == SD_OK) {
        ...
        // DEBUG
#ifdef SD_VERBOSE_POWER_ON
        UART_StrInt("SD_CMD_APP_CMD1: ", errorstatus);
#endif
    }
    /*!< CMD55 */
    SDIO_CmdInitStructure.SDIO_Argument = 0x00;
    ...
    // DEBUG
#ifdef SD_VERBOSE_POWER_ON
    UART_StrInt("SD_CMD_APP_CMD2: ", errorstatus);
#endif
    ...
    if (errorstatus == SD_OK) {
        ...
        while ((!validvoltage) && (count < SD_MAX_VOLT_TRIAL)) {
            ...
            // DEBUG
#ifdef SD_VERBOSE_POWER_ON
            UART_StrInt("SD_CMD_APP_CMD3: ", errorstatus);
#endif
            ...
            // DEBUG
#ifdef SD_VERBOSE_POWER_ON
            UART_StrInt("SD_CMD_SD_APP_OP_COND: ", errorstatus);
#endif
...
//#define SD_VERBOSE_READ_BLOCK
#ifdef SD_VERBOSE_READ_BLOCK
    UART_PrintString("Read Block\r");
#endif
    ...
    if (SDIO_GetFlagStatus(SDIO_FLAG_DTIMEOUT) != RESET) {
        ...
        #ifdef SD_VERBOSE_READ_BLOCK
        UART_PrintString("SD_DATA_TIMEOUT\r");
        #endif
        return (errorstatus);
        ...
        #ifdef SD_VERBOSE_READ_BLOCK
        UART_PrintString("SD_DATA_CRC_FAIL\r");
        #endif
        return (errorstatus);
        ...
        #ifdef SD_VERBOSE_READ_BLOCK
        UART_PrintString("SD_RX_OVERRUN\r");
        #endif
        return (errorstatus);
        ...
        #ifdef SD_VERBOSE_READ_BLOCK
        UART_PrintString("SD_START_BIT_ERR\r");
        #endif
        return (errorstatus);
    }
    #ifdef SD_VERBOSE_READ_BLOCK
    UART_PrintString("SDIO_FLAG_DBCKEND\r");
    #endif
